    ...
    public partial class InitialData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Companies",
                keyColumn: "CompanyId",
                keyValue: new Guid("59936e1a-fbc2-4685-ba40-fc88b36d35e2"));

            migrationBuilder.DeleteData(
                table: "Companies",
                keyColumn: "CompanyId",
                keyValue: new Guid("72d0db7d-f781-47f4-a5f2-a49364f87fbf"));
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("59936e1a-fbc2-4685-ba40-fc88b36d35e2"), "583 Wall Dr. Gwynn Oak, MD 21207", "USA", "IT_Solutions Ltd" },
                    { new Guid("72d0db7d-f781-47f4-a5f2-a49364f87fbf"), "312 Forest Avenue, BF 923", "USA", "Admin_Solutions Ltd" }
                });
        }
    }
}
